...
<body>
	<s:if test="%{validacion}">
		<s:set var="panel" value="%{'login-panel panel panel-danger'}"/>
		<s:set var="title" value="%{'Login Error'}" />
	</s:if>
	<s:else>
		<s:set var="panel" value="%{'login-panel panel panel-primary'}"/>
		<s:set var="title" value="%{'Login'}" />
	</s:else>
