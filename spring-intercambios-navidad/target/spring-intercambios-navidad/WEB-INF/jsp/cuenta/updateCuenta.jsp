...
<head>
    ...
    <title>NAVIDAD ::: ACTUALIZAR CUENTA</title>
</head>
<body>
		...
		<div class="row">
			<div class="col-md-offset-1 col-md-10 col-md-offset-1">
				<div class="panel panel-success">
					...
					<c:url value="/cuenta/update" var="urlForm"/>
					<div class="panel-body">
						<form:form cssClass="well form-vertical" action="${urlForm}" method="POST" commandName="userCuenta">
						<form:hidden path="idUsuario"/>
						<form:hidden path="idCustomer"/>
						<form:hidden path="flagSaveUpdate" value="update"/>
						<div class="row">
							<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="input-group ${status.error ? 'has-error' : ''}">
						  			<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
					      			<input type="text" class="form-control" placeholder="Usuario" value="${userCuenta.user}" disabled="disabled"/>
					    ...
					    <div class="row">
					    	...
					    	<div class="col-md-2">
					    		<div class="input-group">
							      	<a href='<c:url value="/cuenta"/>' class="btn btn-sm btn-danger">Cancelar</a>
							     </div>
					    	</div>
					    </div>
						</form:form>
